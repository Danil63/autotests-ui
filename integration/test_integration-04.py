...
def test_integration_01():
    ...
    with sync_playwright() as p:
        ...
        file_path = "/Users/mbookpro403gmail.com/Downloads/sample-5s.mp4"
        ...
        search_input.fill('Ремонт замков на сумках')
        expect(search_input).to_have_value('Ремонт замков на сумках')
        ...
        auto = page.locator('//button[@class="inline-flex items-center justify-center text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none bg-purple text-white disabled:opacity-100 disabled:bg-slate-900/5 disabled:text-slate-900/30 h-10 rounded-2lg px-3 py-2 font-normal"]')
        auto.scroll_into_view_if_needed()
        auto.wait_for(state="visible", timeout=180000000)
...
def test_integration_02():
    with sync_playwright() as p:
        ...
        while True:
            ...
            try:
                card_company_integration = page.locator('//span[text()="Ремонт замков на сумках"]')
...
def test_integration_04():
    ...
    with sync_playwright() as p:
        ...
        page.locator('//span[text()="Ремонт замков на сумках"]').click()
...
def test_integration_06():
    ...
    with sync_playwright() as p:
        ...
        card = page.locator('//span[text()="Ремонт замков на сумках"]').first
        card.click()
