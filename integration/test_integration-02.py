...
def test_integration_01():
    ...
    with sync_playwright() as p:
        ...
        search_input.fill('заклепки')
        expect(search_input).to_have_value('заклепки')
...
def test_integration_02():
    with sync_playwright() as p:
        ...
        while True:
            ...
            try:
                card_company_integration = page.locator('//span[text()="заклепки"]')
...
def test_integration_04():
    ...
    with sync_playwright() as p:
        ...
        page.locator('//span[text()="заклепки"]').click()
...
def test_integration_06():
    ...
    with sync_playwright() as p:
        ...
        card = page.locator('//span[text()="заклепки"]').first
        card.click()
