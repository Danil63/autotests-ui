...
def test_integration_01():
    ...
    with sync_playwright() as p:
        ...
        search_input.fill('медный брусок')
        expect(search_input).to_have_value('медный брусок')
...
def test_integration_02():
    with sync_playwright() as p:
        ...
        # Работа с карточками
        card_company = page.locator('//*[text()="AUTO-TEST Фикса + товар БЕЗ авто"]')
        card_company.click()
...
def test_integration_03():
    ...
    with sync_playwright() as p:
        ...
        while True:
            ...
            try:
                card_company_integration = page.locator('//span[text()="медный брусок"]')
       ...
       # Шаг 1
        ...
        button3 = page.locator('//button[contains(text(),"Отправить")]').first
...
def test_integration_05():
    ...
    with sync_playwright() as p:
        ...
        page.locator('//span[text()="медный брусок"]').click()
...
def test_integration_07():
    ...
    with sync_playwright() as p:
        ...
        card = page.locator('//span[text()="медный брусок"]').first
        card.click()
