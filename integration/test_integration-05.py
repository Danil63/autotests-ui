...
def test_integration_01():
    ...
    with sync_playwright() as p:
        ...
        search_input.fill('Лом меди')
        expect(search_input).to_have_value('Лом меди')
...
def test_integration_02():
    with sync_playwright() as p:
        ...
        while True:
            ...
            try:
                card_company_integration = page.locator('//span[text()="Лом меди"]')
...
def test_integration_04():
    ...
    with sync_playwright() as p:
        ...
        page.locator('//span[text()="Лом меди"]').click()
...
def test_integration_06():
    ...
    with sync_playwright() as p:
        ...
        card = page.locator('//span[text()="Лом меди"]').first
        card.click()
